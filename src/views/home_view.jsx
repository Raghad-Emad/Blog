...
export default props => {
    ...
    const renderUserPtofile = () => {
        return (
            <div className="hidden w-full block lg:flex items-center w-auto" id="menu">
                ...
                <div className="w-12 h-12 relative flex justify-center items-center rounded-full bg-cyan-800 text-xl text-white uppercase">
    ...
    const renderFooterHeader = () => {
        return (
            <footer className="py-3 bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 text-center text-white">
                Copyright © 2022 Blog. All rights reserved
            </footer>
        )
    }
